...
const listenToGeographicAddressValidationStateChangeEvent = async (request, response) => {
  await Controller.handleRequest(request, response, service.listenToGeographicAddressValidationStateChangeEvent);
};
