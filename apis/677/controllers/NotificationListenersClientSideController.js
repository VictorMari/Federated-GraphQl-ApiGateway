...
const listenToUsageConsumptionReportRequestStateChangeNotification = async (request, response) => {
  await Controller.handleRequest(request, response, service.listenToUsageConsumptionReportRequestStateChangeNotification);
};
